...
<body>
  ...
  <div class="form-area">
    <form class="row g-3" action="../actions/create.php" method="post">
      <div class="col-md-4">
      ...
      <div class="col-4">
        ...
        <input type="date" name="nascimento" class="form-control" id="input-nascimento" required>
      </div>
      ...
      <div class="col-md-6">
        ...
        <input type="number" name="unidade_consumidora" class="form-control" id="input-uc" required>
      </div>

      <div class="col-md-4">
        <label for="input-vencimento" class="form-label">Vencimento</label>
        <input type="date" name="data_vencimento" class="form-control" id="input-vencimento" required>
      </div>

      <div class="col-md-8">
        <label for="input-consumo" class="form-label">Consumo Kw/h</label>
        <input type="number" name="kwh" class="form-control" id="input-consumo" required>
      </div>

      <div class="col-md-12">
        <label for="input-total" class="form-label">Total</label>
        <input type="number" name="valor_total" class="form-control" id="input-total" required>
      </div>

      <div class="col-10">
        <label for="input-sexo" class="form-label">Sexo</label>
        <div class="form-radio">
          <input class="form-radio-input" name="sexo" value="Masculino" type="radio" id="input-masculino" required>
        ...
        <div class="form-radio">
          <input class="form-radio-input" name="sexo" value="Feminino" type="radio" id="input-feminino" required>
